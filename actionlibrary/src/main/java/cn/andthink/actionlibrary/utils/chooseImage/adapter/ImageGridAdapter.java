package cn.andthink.actionlibrary.utils.chooseImage.adapter;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, boolean showCamera) {
        ...
        bitmapUtils.configDefaultLoadFailedImage(R.drawable.default_error);//加载失败显示的图片
        bitmapUtils.configDefaultLoadingImage(new ColorDrawable(Color.parseColor("#f5f5f5")));
    }
        ...
        void bindData(final Image data) {
            ...
            if (mItemSize > 0) {
              ...
              /*  Picasso.with(mContext)
                        ...
                        .centerCrop()
                        .into(image);*/
                bitmapUtils.display(image, imageFile.getAbsolutePath());
            }
        }
    }
